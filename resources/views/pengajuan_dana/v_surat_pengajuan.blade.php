...
@section('sub_title','Surat Pengajuan Dana')
      ...
      <div class="col-12">
        ...
        <div class="invoice p-3 mb-3">
            ...
            <div class="col-12 table-responsive" style='padding-right:100px; padding-left:100px;'>
              <table class="table " >
                    ...
                    <tr>
                        ...
                        <td>Rp. 0</td>
                        <th class="text-right" rowspan="3" style='vertical-align: top;'>Rute</th>
          ...
          <div class="row no-print">
            <div class="col-12">
                <a href="/pengajuan_dana/suratPengajuan_print/{{$jadwal->id}}" rel="noopener" target="_blank" class="btn btn-default float-right" style="margin-right: 5px;"><i class="fas fa-print"></i> Print</a>
            </div>
          </div>
        </div>
        <!-- /.invoice -->
