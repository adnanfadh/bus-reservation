    ...
    <form action="/paket/insert" method="post" enctype="multipart/form-data">
        ...
        <div class="content">
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="text" name="nama_paket" id="" class="form-control @error('nama_paket') is-invalid @enderror" placeholder="Nama Paket" value="{{ old('nama_paket') }}"aria-describedby="helpId">
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-3">
                    <select class="form-control select2 @error('id_penjadwalan') is-invalid @enderror" name="id_penjadwalan" id="" style="width: 100%;">
                        ...
                        <option value='{{ $data->id }}' @if (old('id_penjadwalan') == $data->id ) selected @endif>{{$data->nama_jadwal}}</option>
                        @endforeach
                    </select>
                  <div class="text-danger">
                    @error('id_jadwal')
            ...
            <div class="form-group row" >
                ...
                <div class=" col-sm-2">
                  <input type="number" name="nominal_harga" id="" class="form-control @error('nominal_harga') is-invalid @enderror" placeholder="Nominal Harga" value="{{ old('nominal_harga') }}"aria-describedby="helpId" autofocus>
                  <div class="text-danger">
                    @error('nominal_harga')
                      {{$message}}
                    @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                    <select class="form-control @error('status') is-invalid @enderror" name="status" id="" style="width: 100%;">
                        <option value='' >-- Pilih --</option>
                        <option value='Ada' @if (old('status') == 'Ada' ) selected @endif>Ada</option>
                        <option value='Tidak Ada' @if (old('status') == 'Tidak Ada' ) selected @endif>Tidak Ada</option>
