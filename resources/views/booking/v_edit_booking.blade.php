        ...
        <div class="content">
            <div class="form-group row" >
                ...
                <div class=" col-sm-3 input-group">
                    ...
                    <input type="number" name="idbooking" id="" class="form-control @error('idbooking') is-invalid @enderror" placeholder="No di belakang 0" value="{{ $booking->id }}" aria-describedby="helpId" autofocus>
            ...
            <div id="User">
                <div class="row form-group" >
                    ...
                    <div class="col-sm-5">
                      <input type="text" name="nama_kostumer" id="" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama Lengkap" value="{{ $booking->nama_kostumer }}"aria-describedby="helpId">
                      <div class="text-danger">
                        @error('nama')
                          {{$message}}
                        @enderror
                ...
                <div class="row form-group" >
                    ...
                    <div class="col-sm-5">
                        <textarea name="alamat_kostumer" id="" cols="9" rows="2" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat">{{ $booking->alamat_kostumer }}</textarea>
                ...
                <div class="row form-group" >
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="telp_kostumer" id="" class="form-control @error('telp') is-invalid @enderror" placeholder="Telepon" value="{{ $booking->telp_kostumer }}"aria-describedby="helpId">
                        <div class="text-danger">
                            @error('telp')
                            {{$message}}
                            @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                    <select class="form-control @error('status_booking') is-invalid @enderror" name="status_booking" id="" style="width: 100%;">
                        ...
                        <option value='Pending' @if ($booking->status_booking == 'Pending' ) selected @endif >Pending</option>
            ...
            <div class="form-group row" >
                ...
                <div class="col-sm-3">
                    <select class="form-control  @error('id_karyawan') is-invalid @enderror" name="id_karyawan" id="tipe_kend" style="width: 100%;">
                        <option value="" selected disabled>-- pilih --</option>
                        @foreach ($marketing as $dataMarketing)
                        <option value='{{ $dataMarketing["id_karyawan"] }}' @if ($booking->id_karyawan == $dataMarketing["id_karyawan"] ) selected @endif>{{$dataMarketing["nama_karyawan"]}}</option>
                        @endforeach
                    </select>
                  <div class="text-danger">
                    @error('id_karyawan')
