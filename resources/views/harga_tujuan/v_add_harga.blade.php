...
@section('sub_title','Tambah Harga Tujuan')

@section('content')
    <a href="/harga_tujuan" class="btn btn-sm btn-success" style="margin: 5px 5px 5px 5px;">Kembali</a>

    <form action="/harga_tujuan/insert" method="post" enctype="multipart/form-data">
        @csrf
        <div class="content">
                ...
                <div class="col-sm-2">
                    <select class="form-control select2 @error('idTujuan_awal') is-invalid @enderror" name="idTujuan_awal" id="" style="width: 100%;">
                        ...
                        @foreach ($tujuan as $data)
                            <option value='{{ $data->id }}' @if (old('idTujuan_awal') == $data->id ) selected @endif>{{$data->nama_tujuan}}</option>
                        @endforeach
                        </select>
                      <div class="text-danger">
                        @error('idTujuan_awal')
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                    <select class="form-control select2 @error('idTujuan_akhir') is-invalid @enderror" name="idTujuan_akhir" id="" style="width: 100%;">
                        <option value="">-- pilih --</option>
                        @foreach ($tujuan as $data)
                            <option value='{{ $data->id }}' @if (old('idTujuan_akhir') == $data->id ) selected @endif>{{$data->nama_tujuan}}</option>
                        @endforeach
                        </select>
                      <div class="text-danger">
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="konsumsi_solar" id="konsumsiSolar" class="form-control @error('konsumsi_solar') is-invalid @enderror" placeholder="Konsumsi Solar" value="{{ old('konsumsi_solar') }}"aria-describedby="helpId">
                  <div class="text-danger">
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="rupiah_solar" id="rupiahSolar" class="form-control @error('rupiah_solar') is-invalid @enderror" placeholder="Harga Bahan Bakar" value="{{ old('rupiah_solar') }}"aria-describedby="helpId">
                  <div class="text-danger">
                    @error('rupiah_solar')
                      {{$message}}
                    @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="jum_supir" id="" class="form-control @error('jum_supir') is-invalid @enderror" placeholder="Jumlah Supir" value="{{ old('jum_supir') }}"aria-describedby="helpId">
                  <div class="text-danger">
                    @error('jum_supir')
                      {{$message}}
                    @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="jum_kernet" id="" class="form-control @error('jum_kernet') is-invalid @enderror" placeholder="Jumlah Kernet" value="{{ old('jum_kernet') }}"aria-describedby="helpId">
                  <div class="text-danger">
                    @error('jum_kernet')
                      {{$message}}
                    @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="min_hari" id="" class="form-control @error('min_hari') is-invalid @enderror" placeholder="Minimal Hari" value="{{ old('min_hari') }}"aria-describedby="helpId">
                  <div class="text-danger">
                    @error('min_hari')
                      {{$message}}
                    @enderror
            ...
            <div class="row form-group" >
                ...
                <div class="col-sm-2">
                  <input type="number" name="harga" id="" class="form-control @error('harga') is-invalid @enderror" placeholder="Harga" value="{{ old('harga') }}"aria-describedby="helpId">
                  <div class="text-danger">
                    @error('harga')
                      {{$message}}
                    @enderror
